...
const STATUS_CLASS: Record<AnimatedBadgeStatus, string> = {
  neutral: "border-neutral-200 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-800/80 text-neutral-700 dark:text-neutral-300",
  info: "border-sky-500/30 bg-sky-500/10 text-sky-600 dark:text-sky-400",
  success: "border-emerald-500/30 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
  warning: "border-amber-500/30 bg-amber-500/10 text-amber-600 dark:text-amber-400",
  danger: "border-rose-500/30 bg-rose-500/10 text-rose-600 dark:text-rose-400",
  loading: "border-blue-500/30 bg-blue-500/10 text-blue-600 dark:text-blue-400",
};
