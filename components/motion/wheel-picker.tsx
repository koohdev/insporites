...
export function WheelPicker({
  ...
  return (
    <div
      ...
      className={cn(
        "relative touch-none select-none overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 outline-none focus-visible:ring-2 focus-visible:ring-neutral-400/50",
    ...
    >
      ...
      >
        {options.map((option, i) => (
          <li
            ...
            data-index={i}
            className="absolute inset-x-0 flex items-center justify-center font-medium text-neutral-500 dark:text-neutral-400"
            style={{
              top: -itemHeight / 2,
              height: itemHeight,
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-1/2 z-10 -translate-y-1/2 overflow-hidden rounded-md bg-neutral-900/5 dark:bg-white/10"
        ...
        >
          {options.map((option, i) => (
            <li
              key={optionValue(option)}
              data-index={i}
              className="absolute inset-x-0 flex items-center justify-center font-medium text-neutral-900 dark:text-neutral-100"
              style={{
                top: -itemHeight / 2,
                height: itemHeight,
                transform: `rotateX(${-itemAngle * i}deg) translateZ(${radius}px)`,
