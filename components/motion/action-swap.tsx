...
const VARIANT_CLASS: Record<ActionSwapButtonVariant, string> = {
  primary:
    "bg-neutral-900 text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100 shadow-xs font-medium",
  secondary:
    "border border-neutral-200/90 bg-neutral-100 text-neutral-900 hover:bg-neutral-200/80 dark:border-neutral-700/80 dark:bg-neutral-800 dark:text-neutral-100 dark:hover:bg-neutral-700/80 shadow-xs font-medium",
  outline:
    "border border-neutral-300/90 bg-white text-neutral-900 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800 shadow-xs font-medium",
  ghost:
    "text-neutral-800 hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-800 font-medium",
};
