...
const STATUS_TONE: Record<FileUploadStatus, string> = {
  ...
  uploading: "text-neutral-900 dark:text-white",
...
function FileUploadRow({
  ...
  return (
    <motion.li
      ...
      className={cn(
        "relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-3",
        classNames?.item,
      )}
    >
      <div className="flex items-center gap-3">
        <div
          className={cn(
            "grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400",
            classNames?.leading,
          )}
        >
        ...
        <div className={cn("min-w-0 flex-1", classNames?.content)}>
            ...
            <div className="flex shrink-0 items-center gap-1">
              ...
              {status === "error" ? (
                <button
                  ...
                  className={cn(
                    "grid h-7 w-7 place-items-center rounded-full text-neutral-500 dark:text-neutral-400 transition-colors duration-150 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-neutral-900 dark:hover:text-white active:scale-95",
                    classNames?.action,
                  )}
                >
          ...
          {showProgress ? (
            <div
              ...
              className={cn(
                "mt-3 h-1.5 overflow-hidden rounded-full bg-neutral-100 dark:bg-neutral-800",
                classNames?.progress,
              )}
            >
              <motion.div
  ...
  return (
    <div className={cn("w-full space-y-3", className, classNames?.root)}>
      ...
      <button
        ...
        className={cn(
          "group relative flex w-full overflow-hidden rounded-3xl border border-dashed border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 outline-none",
          "transition-[border-color,transform] duration-200 active:scale-[0.99]",
          "hover:border-neutral-400 dark:hover:border-neutral-500 focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-950",
          "data-[dragging=true]:border-neutral-900 dark:data-[dragging=true]:border-white",
      ...
      >
        <motion.span
          aria-hidden="true"
          className={cn(
            "grid shrink-0 place-items-center bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white",
            centered
              ? "h-16 w-16 rounded-[1.35rem] border border-neutral-200 dark:border-neutral-700"
        ...
        <span className={cn("min-w-0", centered ? "max-w-xs" : "flex-1")}>
          <span
            className={cn(
              "block font-semibold text-neutral-900 dark:text-white",
        ...
        <span
          className={cn(
            "shrink-0 rounded-full border border-neutral-200 dark:border-neutral-700 text-xs font-medium text-neutral-900 dark:text-white transition-colors duration-150 group-hover:bg-neutral-100 dark:group-hover:bg-neutral-800",
