    ...
    return (
      <Tooltip content="Removing attachment" side="top" delay={100}>
        <span
          ...
          className="grid size-9 shrink-0 place-items-center rounded-xl text-neutral-500 dark:text-neutral-400"
        >
          <motion.span
      ...
      return (
        <Tooltip content="Upload failed" side="top" delay={100}>
          <span
            ...
            className="grid size-9 shrink-0 place-items-center rounded-xl text-rose-600 dark:text-rose-400"
          >
    ...
    return (
      <Tooltip content="Retry upload" side="top" delay={100}>
        <motion.button
          ...
          className="grid size-9 shrink-0 place-items-center rounded-xl text-rose-600 dark:text-rose-400 outline-none transition-colors hover:bg-rose-500/10 focus-visible:ring-2 focus-visible:ring-neutral-400"
        >
  ...
  return (
    <Tooltip content="Remove attachment" side="top" delay={100}>
      <motion.button
        ...
        whileTap={reduce ? undefined : { scale: 0.92 }}
        transition={SPRING_PRESS}
        className="grid size-9 shrink-0 place-items-center rounded-xl text-neutral-500 dark:text-neutral-400 outline-none transition-colors hover:bg-neutral-200/80 dark:hover:bg-neutral-800 hover:text-neutral-900 dark:hover:text-white focus-visible:ring-2 focus-visible:ring-neutral-400"
      >
        <X className="size-4" />
      </motion.button>
    </Tooltip>
...
function ImageThumbnail({
  ...
  if (!src) {
    return (
      <span
        aria-hidden="true"
        className="grid size-8 shrink-0 place-items-center rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400"
      >
  ...
  return (
    <Tooltip
      ...
      className="rounded-xl p-1 shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800"
      content={
        <span className="block w-32">
          ...
          />
          <span className="block px-1 pb-0.5 pt-1 text-center text-[10px] font-medium text-neutral-500 dark:text-neutral-400">
            Click to preview
          </span>
        </span>
      }
    >
      <motion.button
        ...
        transition={SPRING_PRESS}
        className="group/image relative size-9 shrink-0 overflow-hidden rounded-[10px] bg-neutral-100 dark:bg-neutral-800 outline-none ring-1 ring-neutral-200 dark:ring-neutral-800 focus-visible:ring-2 focus-visible:ring-neutral-400"
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={reduce ? undefined : { scale: 0.92 }}
              transition={SPRING_PRESS}
              className="absolute -right-3 -top-3 grid size-9 place-items-center rounded-full bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white shadow-xl outline-none ring-1 ring-neutral-200 dark:ring-neutral-800 transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800 focus-visible:ring-2 focus-visible:ring-neutral-400"
            >
              <X className="size-4" />
            </motion.button>
          </motion.div>
...
function AttachmentRow({
  ...
  return (
    <motion.li
      ...
      className={cn(
        "flex min-h-14 items-center gap-1 rounded-2xl bg-neutral-100/70 dark:bg-neutral-900/80 border border-neutral-200/80 dark:border-neutral-800/80 p-1",
        className,
      )}
    >
      <div className="relative isolate flex min-w-0 flex-1 items-center gap-3 self-stretch overflow-hidden rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200/60 dark:border-neutral-800/60 px-2 py-1">
        {failed ? (
          <span
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 -z-10 bg-rose-500/10"
          />
        ) : null}
        ...
        {item.kind === "image" ? (
          ...
          <span
            aria-hidden="true"
            className="grid size-7 shrink-0 place-items-center text-neutral-500 dark:text-neutral-400"
          >
        ...
        {item.kind === "audio" ? (
          <>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.94 }}
              transition={SPRING_PRESS}
              className="grid size-9 shrink-0 place-items-center rounded-full bg-neutral-900 text-white dark:bg-white dark:text-neutral-900 outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-900"
            >
          ...
          <>
            <span className="min-w-0 flex-1">
              ...
              {failed ? (
                <span className="block truncate text-[11px] text-rose-600 dark:text-rose-400">
            ...
            {item.kind === "link" && item.href ? (
              <a
                ...
                className="grid size-8 shrink-0 place-items-center rounded-lg text-neutral-500 dark:text-neutral-400 outline-none transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-neutral-900 dark:hover:text-white focus-visible:ring-2 focus-visible:ring-neutral-400"
              >
  ...
  return (
    <LayoutGroup id={inputId}>
      ...
      <motion.button
        ...
        className={cn(
          "group relative isolate flex min-h-52 w-full flex-col items-center justify-center overflow-hidden rounded-[2rem] bg-neutral-100/70 dark:bg-neutral-900/70 p-2 text-center outline-none border border-neutral-200 dark:border-neutral-800",
          "transition-colors duration-200 hover:bg-neutral-100 dark:hover:bg-neutral-900",
          "focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-neutral-950",
          "data-[dragging=true]:bg-neutral-200/60 dark:data-[dragging=true]:bg-neutral-800/60",
      ...
      >
        <span
          aria-hidden="true"
          className="absolute inset-2 -z-10 rounded-[1.5rem] border border-dashed border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 transition-[border-color,background-color] duration-200 group-hover:border-neutral-400 dark:group-hover:border-neutral-500 group-data-[dragging=true]:border-neutral-900 dark:group-data-[dragging=true]:border-white group-data-[dragging=true]:bg-neutral-100/50 dark:group-data-[dragging=true]:bg-neutral-900/50"
        />
        <motion.span
          aria-hidden="true"
          animate={
          ...
          transition={ITEM_TRANSITION}
          className="mb-3 grid size-11 place-items-center rounded-2xl bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-white transition-colors duration-200 group-hover:bg-neutral-200 dark:group-hover:bg-neutral-700 group-data-[dragging=true]:bg-neutral-900 dark:group-data-[dragging=true]:bg-white group-data-[dragging=true]:text-white dark:group-data-[dragging=true]:text-neutral-900"
        >
          <Upload className="size-[18px]" />
        </motion.span>
        <span className="text-sm font-semibold tracking-[-0.01em] text-neutral-900 dark:text-white">
