...
export function ComboboxTrigger({ children, className }: ComboboxTriggerProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative z-20 flex h-10 w-full min-w-52 cursor-text items-center justify-between gap-3 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 px-3 text-sm text-neutral-900 dark:text-neutral-100 transition-[border-color] hover:border-neutral-400 dark:hover:border-neutral-600 shadow-xs",
        "focus-within:ring-2 focus-within:ring-neutral-400/50",
  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={cn(
          "h-10 min-w-0 flex-1 bg-transparent text-sm text-neutral-900 dark:text-neutral-100 outline-none placeholder:text-neutral-400 disabled:cursor-not-allowed",
          className,
        )}
      />
    </div>
