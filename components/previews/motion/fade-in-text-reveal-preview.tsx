...
import { FadeInTextReveal } from "@/components/motion/text-reveal";
import { cn } from "@/lib/utils";

export function FadeInTextRevealPreview() {
  ...
  return (
    <div className={cn("w-full h-full flex flex-col items-center justify-center p-4 gap-6", isDark ? "dark" : "")}>
      <div className="flex flex-col items-center justify-center gap-4 text-center max-w-sm">
        <FadeInTextReveal
          key={count}
          text="Crafting fluid interactions and high performance animations."
          type="words"
