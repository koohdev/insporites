...
documentation: "https://beui.dev/components/motion/checkbox"
markdown: "https://beui.dev/components/motion/checkbox.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/checkbox
```
...
- Registry detail: https://beui.dev/r/checkbox
- Raw source: https://beui.dev/r/checkbox/raw
