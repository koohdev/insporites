...
documentation: "https://beui.dev/components/motion/wheel-picker"
markdown: "https://beui.dev/components/motion/wheel-picker.md"
license: "MIT"
---
...
```bash
npx shadcn@latest add @beui/wheel-picker
```
...
- Registry detail: https://beui.dev/r/wheel-picker
- Raw source: https://beui.dev/r/wheel-picker/raw
